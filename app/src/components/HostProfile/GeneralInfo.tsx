  ...
  <React.Fragment>
    <React.Fragment>
      ...
      <GeneralInfoStyle.GeneralContent>
        {`${host.firstName} ${host.lastName}, ${(new Date()).getFullYear() - host.dateOfBirth.getFullYear()}, is the ${hostTypeToString(host.type)} host of a ${host.housingType.toLowerCase()} in ${host.address}`}
      </GeneralInfoStyle.GeneralContent>
    </React.Fragment>
