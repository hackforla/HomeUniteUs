  ...
  <AboutStyle.AboutHolder>
    <AboutStyle.TextBlock>
      ...
      <AboutStyle.AboutText>
        ...
        <h4>Overview</h4>
        <p>
          SPY’s host homes program is centered around housing young people, 18 -
          25 years old. Their approach focuses on low-cost, community-driven
        ...
        <h4>Status</h4>
        <p>
          We're currently seeking additional stakeholders who run similar host
          home/empty bedroom programs, to provide input and feedback on how this
          tool can and could be used. We're also seeking organizations and
          individuals interested in supporting the project financially.
        </p>
        <p>
          If any of these applies to you, please contact Bonnie Wolfe, Hack for
