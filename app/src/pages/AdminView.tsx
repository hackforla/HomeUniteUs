    ...
    <React.Fragment>
      <AdminStyle.MainHolder>
        <AdminStyle.MainHeader>
          <AdminStyle.MainTitle>All Guests Matching</AdminStyle.MainTitle>
        </AdminStyle.MainHeader>
          ...
          <AdminStyle.AdminHolder>
            <AdminStyle.InfoPaper>
              <AdminStyle.HeaderRow>
                <AdminStyle.SecondHeader>Name</AdminStyle.SecondHeader>
                <AdminStyle.SecondHeader>Status</AdminStyle.SecondHeader>
                <AdminStyle.SecondHeader>Matches</AdminStyle.SecondHeader>
              </AdminStyle.HeaderRow>
