...
const reducer = (state: CreateProfileState, action: CreateProfileAction): CreateProfileState => {
    switch (action.type) {
        ...
        <div>
            {
                state.loadingModal.isOpen
                    ...
                    : state.messageModal.isOpen
                        ...
                        >
                            <ul>
                                <li><a onClick={() => { createProfile(ProfileType.Guest) }}>Guest</a></li>
                                <li><a onClick={() => { createProfile(ProfileType.Host) }}>Host</a></li>
                                <li><a onClick={() => { createProfile(ProfileType.Administrator) }}>Administrator</a></li>
                            </ul>
                        </div>
            }
