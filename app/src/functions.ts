...
const dataFunc = {
  ...
  async getSingleGuest(params: string) {
    try {
      const getGuest = await fetch(`http://0.0.0.0:8765/guests/${params}`, {
        method: 'GET',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
      })
  ...
  async guestAdd(guestInfo: Object) {
    try {
      const addGuest = await fetch(`http://0.0.0.0:8765/guests/addguest`, {
        method: 'POST',
        credentials: 'include',
  ...
  async guestEdit(guestInfo: Object) {
    try {
      const editGuest = await fetch(`http://0.0.0.0:8765/guests/editguest`, {
        method: 'PUT',
        credentials: 'include',
        body: JSON.stringify(guestInfo),
        headers: { 'Content-Type': 'application/json' },
  ...
  async guestDelete(params: string) {
    try {
      const deleteGuest = await fetch(`http://0.0.0.0:8765/guests/${params}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
      })
  ...
  async hostEdit(guestInfo: Object) {
    try {
      const editHost = await fetch(`http://0.0.0.0:8765/hosts/editguest`, {
        method: 'PUT',
        credentials: 'include',
        body: JSON.stringify(guestInfo),
        headers: { 'Content-Type': 'application/json' },
  ...
  async hostDelete(params: string) {
    try {
      const deleteHost = await fetch(`http://0.0.0.0:8765/hosts/${params}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
      })
